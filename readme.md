...
Для некоторых драйверо, например, для встроенного драйвера posstgresql строка сооединения с БД 
...
Регистрация списка функций осуществляется с помощью register_rpc_list, которая принимает на вход парамектры defs и self.
